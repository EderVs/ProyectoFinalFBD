...
\begin{itemize}
\item idProducto $\rightarrow$ puntosOtorgar, nombre, precio, descripcion.\\Se tiene que $idProducto^+=\{idProducto,puntosOtorgar, nombre, precio, descripcion\}$, así que el lado izquierdo es superllave y no es violación a la forma normal. \checkmark
\item nombre $\rightarrow$ puntosOtorgar, idProducto, precio, descripcion.\\Se tiene que $nombre^+=\{nombre,puntosOtorgar, idProducto, precio, descripcion\}$, así que el lado izquierdo es superllave y no es violación a la forma normal. \checkmark
\end{itemize}
...
\item idProducto $\rightarrow$ puntosOtorgar, nombre, precio, descripcion. Es el lado izquierdo una superllave, pues $idProducto^+=\{idProducto,puntosOtorgar,\\nombre, precio, descripcion\}$. Entonces cumple con la primer posibilidad para no constituir una violación.
\item  nombre $\rightarrow$ puntosOtorgar, idProducto, precio, descripcion. Es el lado izquierdo una superllave, pues $nombre^+=\{nombre,puntosOtorgar,\\ idProducto, precio, descripcion\}$. Entonces cumple con la primer posibilidad para no constituir una violación.
\end{itemize}
