--deseamos que cada que se haga un producto (lo cual sabemos cuando se agrega un elemento a contener)
--actualicemos la cantidad en existencia de dicho ingrediente, además verificaremos si es posible
--realizar todo el pedido con la cantidad de ingredientes en almacén
