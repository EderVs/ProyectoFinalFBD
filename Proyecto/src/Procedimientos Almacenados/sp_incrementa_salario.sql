--función que incrementa el sueldo de los empleados en un porcentaje dado. 
--Será útil debido a la continua inflación monetaria
create or replace procedure inc_sal(inc float) is
begin
	update empleado
